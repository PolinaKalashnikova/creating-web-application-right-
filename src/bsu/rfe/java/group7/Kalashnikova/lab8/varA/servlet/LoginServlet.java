...
// Вывести форму
        pw.println("<form action='/web_application_war_exploded/' method='post'>Введите имя пользователя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
